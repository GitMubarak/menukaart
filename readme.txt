...
* Food item font color option
* Food item font size option
...
Install Menukaart as a regular WordPress plugin. Here are different ways to install plugin:
...
5. Setup the proper settings in Menukaart menu

**Install by upload plugin:**

1. Download the latest version of Menukaart (.zip file)
2. In your Admin, go to menu Plugins > Add New
3. Select "Upload Plugin"
4. Click on "Choose File"
5. Select downloaded menukaart.zip and click on "Install Now" button
...
* Food item font color and size option added
...
* Menu container width option added
